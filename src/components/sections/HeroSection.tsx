    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-28 pb-20 w-full">
        ...
        <h1
          ...
          style={{ fontSize: 'clamp(3.5rem,10vw,8rem)', color: 'var(--text-main)' }}
        >
          {tr.line1}<br />
        ...
        <div className="flex items-baseline gap-3 mb-6 flex-wrap">
          ...
          <span
            className="font-heading tracking-widest uppercase"
            style={{ fontSize: 'clamp(1rem, 2.5vw, 1.6rem)', color: 'var(--text-main)', lineHeight: 1 }}
          >
            Minute Install
          </span>
          <span
        ...
        <p className="text-sm font-medium tracking-wide mb-10" style={{ color: 'var(--text-muted)' }}>
